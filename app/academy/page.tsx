    ...
    <main>
      ...
      >
        <div>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            <Link href="/academy/start" className="btn btn-primary blueprint" style={{ fontSize: 15, padding: "11px 20px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <Link href="/academy/m/advanced" className="card blueprint" style={{ padding: 20, gap: 6 }}>
      ...
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "44px 40px 56px" }}>
        <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", marginBottom: 22 }}>
          ...
          <Link href="/academy/commands-list" className="btn btn-ghost">טבלת כל הפקודות ←</Link>
        </div>
        ...
        >
          ...
          >
            ...
            <Link href="/academy/feedback" style={{ fontSize: 14 }}>
