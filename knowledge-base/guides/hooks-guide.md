...
published: "2026-06-24T11:28:37+03:00"
...
| קוד יציאה | משמעות |
| :--------- | :------- |
| `0` | הצלחה — הפעולה ממשיכה כרגיל |
| `2` | חסימה — הפעולה מבוטלת וה-stderr מוחזר למודל |
| כל קוד אחר | שגיאה לא-חוסמת — הפעולה ממשיכה, ה-stderr נרשם ל-debug log ומוצגת התראה בתמלול |
